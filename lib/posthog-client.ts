...
const ALLOWED_EVENT_PROPERTIES = {
  ...
  crop_tip_dismissed: ["tip", "platform"],
  crop_tip_opened: ["tip", "platform"],
  generation_started: [
    "model",
    "target",
    "platform",
  ...
  move_to_references_clicked: ["target", "platform"],
  ...
  prompt_enhancement_failed: ["model", "target", "platform", "error_kind"],
  ...
  template_toggled: ["platform", "visible"],
  wrong_mode_prompt_blocked: ["target", "platform"],
} as const;
